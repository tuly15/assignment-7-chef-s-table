            ...
            <div className="hero rounded-[24px] min-h-[600px] bga" >
                ...
                <div className="hero-content text-center text-neutral-content">
                    <div className="">
                        ...
                        <p className="mb-10 max-w-[933px] text-lg text-white">
                            Embark on a culinary adventure with our "Chef's Table" cooking class, blending hands-on learning with expert guidance for an immersive gastronomic experience like no other.</p>
